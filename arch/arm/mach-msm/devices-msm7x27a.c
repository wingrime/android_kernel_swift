...
struct clk_lookup msm_clocks_7x27a[] = {
	...
	CLK_DUMMY("csi_clk",		CSI0_CLK,	NULL, 0),
	CLK_DUMMY("csi_pclk",		CSI0_P_CLK,	NULL, 0),
	CLK_DUMMY("csi_vfe_clk",	CSI0_VFE_CLK,	NULL, 0),
	CLK_DUMMY("csi_clk",		CSI1_CLK,	NULL, 0),
	CLK_DUMMY("csi_pclk",		CSI1_P_CLK,	NULL, 0),
	CLK_DUMMY("csi_vfe_clk",	CSI1_VFE_CLK,	NULL, 0),
	...
	CLK_DUMMY("hdmi_clk",	HDMI_CLK,	NULL, 0),
	...
	CLK_DUMMY("rotator_clk",	AXI_ROTATOR_CLK,	NULL, OFF),
