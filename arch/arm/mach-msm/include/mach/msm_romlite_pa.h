 ...
 *
 * ROMLITE HS protected applications (PA) format handling
 *
 ...
 *
 */
#ifndef __ARCH_ARM_ROMLITE_PA_H
#define __ARCH_ARM_ROMLITE_PA_H
...
const void *pa_image_address(const u8 *base, const char *filename,
			    size_t *size);
